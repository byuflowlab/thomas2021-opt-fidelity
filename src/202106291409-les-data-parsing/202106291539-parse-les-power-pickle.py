...
def pickle_to_csv(case="low_ti",layout=""):
    ...
    filename="/Users/jaredthomas/OneDrive - BYU/Documents/Jared/School/PhD/Data/thomas2021-opt-fidelity/saved_sowfa_"+case2+"_byu_38turb"+layout2+".p"
    ...
    np.savetxt("turbine-power-"+case+"-les"+layout+".txt", np.c_[turbinepower.T], header=np.array2string(winddirections))



if __name__ == "__main__":
    pickle_to_csv(case="high-ti", layout="")
