...
nrotorpoints = 100
rotor_sample_points_y, rotor_sample_points_z = ff.sunflower_points(nrotorpoints)
...
k1 = 0.3837
k2 = 0.003678
wake_deficit_model = ff.GaussYawVariableSpread(alphastar, betastar, k1, k2, [1.0])

wake_deflection_model = ff.GaussYawVariableSpreadDeflection(alphastar, betastar, k1, k2)
wake_combination_model = ff.LinearLocalVelocitySuperposition()
local_ti_model = ff.LocalTIModelMaxTI(alphastar, betastar, k1, k2)

# initialize model set
model_set = ff.WindFarmModelSet(wake_deficit_model, wake_deflection_model, wake_combination_model, local_ti_model)