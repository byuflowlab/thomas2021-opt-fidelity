...
function wind_farm_setup(nturbines)
    ...
    nrotorpoints = 100
    rotor_points_y, rotor_points_z = ff.rotor_sample_points(nrotorpoints, method="sunflower", pradius=1.0)

    # load tuned parameters
    windandtidata = readdlm("../202105181144-38-turb-tune-to-sowfa/tuned-parameters-high-ti-alldirections-ws-and-ti.csv", ',', skipstart=1)
